 ...
 * @since 1.0.2
 */
public class RequestData implements HttpServletRequest {
	...
	/**
	 * Create a new {@code RequestData} with a default
	 * {@link MockServletContext}.
	 * @see #RequestData(ServletContext, String, String)
	 */
	public RequestData() {
		this(null, "", "");
	}
	 ...
	 * @see #RequestData(ServletContext, String, String)
	 */
	public RequestData(@Nullable String method, @Nullable String requestURI) {
		this(null, method, requestURI);
	}

	/**
	 * Create a new {@code RequestData} with the supplied {@link ServletContext}.
	 * @param servletContext the ServletContext that the request runs in
	 * (may be {@code null} to use a default {@link MockServletContext})
	 * @see #RequestData(ServletContext, String, String)
	 */
	public RequestData(@Nullable ServletContext servletContext) {
		this(servletContext, "", "");
	}
	 ...
	 */
	public RequestData(@Nullable ServletContext servletContext, @Nullable String method, @Nullable String requestURI) {
